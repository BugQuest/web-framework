...
{
    public static function parse(mixed $callback): array|callable
    {
        ...
        if (is_string($callback)) {
            ...
            if (count($exploded) === 2) return [new $exploded[0], $exploded[1]];

            $exploded = explode('::', $callback);
            if (count($exploded) === 2) return [$exploded[0], $exploded[1]];
        }
